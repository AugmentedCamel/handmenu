...
namespace HandMenuPackages.HandCore
{
    ...
    public class GestureDetector : MonoBehaviour
    {
        ...
        void Start()
        {
            // I created a Coroutine that will initialize the Bone when the Oculus has internally initialized its bones
            StartCoroutine(UntilInitialized());
        }

        // Until the OVRBones are not initialized, we return null. When it initialized the bones
